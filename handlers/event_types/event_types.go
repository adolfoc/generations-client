...
func MakeEventTypesTemplate(r *http.Request, pageTitle, studyTitle string, page int, eventTypes *model.EventTypes) (*EventTypesTemplate, error) {
	ct, err := handlers.MakeCommonTemplate(r, studyTitle, pageTitle)
	if err != nil {
		return nil, err
	}
